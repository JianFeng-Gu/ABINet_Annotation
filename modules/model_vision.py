...
# config.model_vision_backbone = 'transformer'  ResTranformer()
# config.model_vision_attention == 'position'   PositionAttention()
# backbone + attention + Linear_Layer
class BaseVision(Model):
    def __init__(self, config):
        ...
        # self.charset.num_classes: text classes
    ...
    def forward(self, images, *args):
        features = self.backbone(images)  # (N, E, H, W) N:batch_size E:embedding dimension
